# TopUtile V2 — mise en ligne très simple

Cette archive contient la V2 complète du site.

## Ce qui a changé
- design beaucoup plus professionnel et mobile-first ;
- page d'accueil structurée comme un vrai site de recommandations ;
- priorité éditoriale Auto & mobilité ;
- suppression des prix figés ;
...
1. Ouvre le dépôt `toputile.github.io`.
...
Avant de faire beaucoup de publicité, complète tes informations d'éditeur/contact dans `mentions-legales.html` et `confidentialite.html`.
